...
// Optional: Icon mapping if you want icons based on title/ID
const iconMap = {
  "Digital Marketing": <BarChart3 className="w-6 h-6 text-indigo-600" />,
  "Social Media Advertising": <Target className="w-6 h-6 text-indigo-600" />,
  "Social Media Management": <Users className="w-6 h-6 text-indigo-600" />,
  ...
  "B2B Lead Generation": <Globe className="w-6 h-6 text-indigo-600" />,
  "Instagram Organic Growth": <Star className="w-6 h-6 text-indigo-600" />,
  ...
  "Website Creation & Design": <Palette className="w-6 h-6 text-indigo-600" />,
  "Video Editing": <Camera className="w-6 h-6 text-indigo-600" />,
};
...
export default function OurServices() {
  ...
  return (
    <section className="container mx-auto bg-white py-16 px-4 sm:px-6 lg:px-8 rounded">
      <div className="max-w-7xl mx-auto text-center space-y-3 px-5 md:px-16">
        <h2 className="text-lg font-semibold inline bg-indigo-200 px-3 py-2 rounded text-indigo-700 text-center ">
          Our Services
        </h2>
        <p className="mt-8 text-3xl font-bold text-gray-900 md:text-4xl ">
      ...
      <div className="mt-12 grid gap-8 md:gap-12 lg:gap-24 sm:grid-cols-2 md:grid-cols-3 max-w-7xl content-evenly mx-auto px-2 md:px-6">
